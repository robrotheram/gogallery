...
class Maintenance extends React.Component {
  ...
  render() {
    ...
    return (
      <Row gutter={[16,16]}>
        <Col span={12}>
          <Button type="default" icon={<SyncOutlined />} size="large" style={{"width":"100%"}} onClick={this.showResacanConfirm}> Resacan image folder </Button>
        </Col>
        <Col span={12}>
          <Button type="default" icon={<DeleteOutlined />} size="large" style={{"width":"100%"}} onClick={this.showPurgeConfirm} > Purge cache </Button><br/>
        </Col>
        <Col span={12}>
          <Button type="default" icon={<DeleteOutlined />} size="large" style={{"width":"100%"}} onClick={this.showClearConfirm} > Clear cache </Button><br/>
        </Col>
        <Col span={12}>
